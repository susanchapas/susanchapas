...
export default function Footer() {
  ...
  return (
    <footer className="bg-primary border-accent-blue/20 border-t px-6 py-3 landscape:sticky landscape:bottom-0 landscape:z-40 landscape:py-1.5 lg:sticky lg:bottom-0 lg:z-40 lg:px-12">
