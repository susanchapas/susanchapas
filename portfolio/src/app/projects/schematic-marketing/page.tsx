        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <div className="flex flex-wrap gap-8 text-sm">
              ...
              <div>
                <span className="text-secondary/50 block mb-1">Type</span>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              {caseStudy.result.metrics.map((metric, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: index * 0.1 }}
                  className="p-6 rounded-xl bg-accent-blue/5 border border-accent-blue/10 text-center"
                >
          ...
          <div className="flex flex-wrap gap-3">
            {tools.map((tool, index) => (
              <motion.span
                ...
                className="px-4 py-2 rounded-full bg-accent-blue/5 border border-accent-blue/20 text-secondary font-body text-sm"
              >
                {tool}
              </motion.span>
            ))}
